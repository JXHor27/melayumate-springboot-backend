...
import com.example.demo.scenario.repo.ScenarioMapper;
...
public class ScenarioService {
    ...
    public List<Scenario> getScenariosByUserId(String userId) {
        ...
        if (scenarioList == null) {
            logger.error("Scenario list not found with userId: " + userId);
            throw new ResourceNotFoundException("Scenario list not found with userId: " + userId);
        }
    ...
    public Scenario createScenario(ScenarioCreateDTO dto) {
        ...
        newScenario.setScenarioId(idGenerator.generateScenarioId());
