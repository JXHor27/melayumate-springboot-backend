...
import com.example.demo.modules.flashcard.service.FlashcardService;
...
public class FlashcardController {
    ...
    public ResponseEntity<List<Flashcard>> getCardsByListId(@PathVariable String flashcardListId ) {
        List<Flashcard> flashcards =  flashcardService.getFlashcardsByListId(flashcardListId);
    ...
    @GetMapping("/{flashcardListId}/practice")
    public ResponseEntity<FlashcardListDetailResultDTO> getFlashcardListForPractice(@PathVariable String flashcardListId) {
        FlashcardListDetailResultDTO flashcardList = flashcardService.getFlashcardListForPractice(flashcardListId);
